...
.bg-primary-1 {
  --tw-bg-opacity: 1;
  background-color: rgb(130 52 233 / var(--tw-bg-opacity, 1));
}
...
.bg-banner {
  background-image: url('./assets/background/retrospective-desktop.png');
}
...
.hover\:bg-primary-2:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(153 86 246 / var(--tw-bg-opacity, 1));
}
